      ...
      <div className="max-w-3xl mx-auto px-4">
        <form onSubmit={handleSearch} className="bg-white rounded-2xl shadow-2xl p-6 sm:p-8 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-end">
            <div className="flex-1 w-full">
              <label className="block text-sm font-medium text-slate-700 mb-1.5">
                <span className="flex items-center gap-1.5"><Plane className="w-4 h-4 text-sky-500" /> From</span>
              </label>
              <select
                required
                value={origin}
            ...
            <button
              type="button"
              onClick={handleSwap}
              className="self-center sm:mb-0.5 p-2.5 rounded-full border border-slate-200 hover:bg-slate-50 hover:border-sky-300 transition-colors text-slate-500 hover:text-sky-500"
            ...
            <div className="flex-1 w-full">
              <label className="block text-sm font-medium text-slate-700 mb-1.5">
                <span className="flex items-center gap-1.5"><Plane className="w-4 h-4 text-sky-500 rotate-180" /> To</span>
              </label>
              <select
                required
                value={destination}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">
                <span className="flex items-center gap-1.5"><Calendar className="w-4 h-4 text-sky-500" /> Date</span>
              </label>
              <input
                type="date"
                required
            ...
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1.5">
                <span className="flex items-center gap-1.5"><Users className="w-4 h-4 text-sky-500" /> Passengers</span>
              </label>
              <select
                value={passengers}
